...
class PaymentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_type" do
    assert_difference('PaymentType.count') do
      post payment_types_url, params: { payment_type: { card_number: @payment_type.card_number, method: @payment_type.method, user_id: @payment_type.user_id } }
    end
  ...
  test "should update payment_type" do
    patch payment_type_url(@payment_type), params: { payment_type: { card_number: @payment_type.card_number, method: @payment_type.method, user_id: @payment_type.user_id } }
