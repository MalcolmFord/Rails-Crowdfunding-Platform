...
class RewardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post rewards_url, params: { reward: { amount: @reward.amount, description: @reward.description, project_id: @reward.project_id, remaining_stock: @reward.remaining_stock, title: @reward.title } }
    end
  ...
  test "should update reward" do
    patch reward_url(@reward), params: { reward: { amount: @reward.amount, description: @reward.description, project_id: @reward.project_id, remaining_stock: @reward.remaining_stock, title: @reward.title } }
